...
// To remove the current head and changing the head to next node.
void remove_node(struct list* list){
...
// To check head of the stack is empty  or not.
void* check_empty(struct list* list){
  if(list->head == NULL){
    return NULL;
  }
  else{
